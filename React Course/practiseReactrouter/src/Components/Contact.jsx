        ...
        <>
            <div className='container flex gap-5 h-80 justify-evenly m-10'>
                <div className="img h-full w-full">
                    <img src="https://images.pexels.com/photos/12190795/pexels-photo-12190795.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="randomimage" className='h-full w-full' />
                </div>
